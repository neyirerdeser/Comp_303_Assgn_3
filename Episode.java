...
public class Episode implements Sequenceable<Episode> {
	 ...
	 *
	 * @param pPath location of the episode on the file system.
	 * @param pTVShow TVShow that this episode is a part of
	 * @param pTitle official title of the episode
	 ...
	 */
	protected Episode(File pPath, TVShow pTVShow, String pTitle, int pEpisodeNumber) {
