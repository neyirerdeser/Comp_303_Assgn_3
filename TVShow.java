...
public class TVShow implements Watchable, Bingeable<Episode> {
	 ...
	 */
	protected TVShow(String pTitle, Language pLanguage, String pStudio) {
	 ...
	 * 
	 * @param pPath the path of the file that contains the video of the episode
	 * @param pTitle the title of the episode
	 ...
	 *
	 * @param pNumber the number whose Episode is to be returned
